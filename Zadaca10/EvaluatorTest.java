...
class EvaluatorBuilder{
    static <T extends Comparable<T>>IEvaluator<T> build(String operation){
        if(operation.equals(">")){
...
class Evaluator{
    public static<T extends Comparable<T>> boolean evaluateExpression(T left, T right, String operation){
        IEvaluator<T> evaluator = EvaluatorBuilder.build(operation);
